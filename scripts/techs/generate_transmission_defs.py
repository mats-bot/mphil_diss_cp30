...
# TODO: create a "tech" per transmission line that uses these as their parent "template" and provides the zone names as link_to/link_from.
templates = {
...
with open(snakemake.output[0], "w") as f:
    yaml.dump({"templates": templates}, f, sort_keys=False)
